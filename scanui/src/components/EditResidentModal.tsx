...
export const ResidentEditModal: Component<ResidentEditModalProps> = (
  ...
  const [residentLevel, setResidentLevel] = createSignal<number | undefined>(
    props.currentResident()?.level,
  );
  ...
  const handleChangeLevel = (e: any) => {
    setResidentLevel(e.target.value);
  };
  ...
  const handleSubmitEditResident = () => {
    ...
    let newResident = {
      ...
      level: props.currentResident()!.level,
    } as SResident;
              ...
              <section class={"flex w-full h-fit gap-4 columns-3"}>
                <div class={"flex gap-2 w-full"}>
                  <label class={"flex flex-col w-full"}>
                    ...
                    >
                      <option value={ResidentIDModalHousingUnit.ALPHA}>
                        ALPHA UNIT
                      </option>
                      <option value={ResidentIDModalHousingUnit.BRAVO}>
                        BRAVO UNIT
                      </option>
                      <option value={ResidentIDModalHousingUnit.CHARLIE}>
                        CHARLIE UNIT
                      </option>
                      <option value={ResidentIDModalHousingUnit.DELTA}>
                        DELTA UNIT
                      </option>
                      <option value={ResidentIDModalHousingUnit.ECHO}>
                        ECHO UNIT
                      </option>
                    </select>
                  </label>
                ...
                <div class={"flex gap-2 w-full"}>
                  <label class={"flex flex-col w-full"}>
                    ...
                    {residentValidationErrors().levelError !== null ? (
                      <span class={"text-red-500"}>
                        {residentValidationErrors().levelError}
                      </span>
                    ) : (
                      false
                    )}
